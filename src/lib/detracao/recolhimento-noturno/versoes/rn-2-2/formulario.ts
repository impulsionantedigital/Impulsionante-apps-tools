...
import type { EntradaCalculo, FeriadoDeclarado, SegmentoRegra, Weekday } from './tipos'
...
export type SegmentoFormulario = {
  ...
  /** 🔴 Os feriados MUNICIPAIS e ESTADUAIS, que a lista nacional de `feriados.ts` não cobre e que a
   *  decisão do caso pode computar como dia integral. Na RN-2.2 ganham NOME além da data. */
