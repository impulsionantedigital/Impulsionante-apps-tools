...
export const AVISOS_2025 = {
  ...
  validarJuridicamente: [
    ...
    'No Art. 13, a planilha exige pena cumprida MAIOR que um quinto (ou um quarto, se reincidente), numa comparação estrita, enquanto o texto do dispositivo fala em "tenham cumprido um quinto da pena". Todos os demais dispositivos, inclusive o §4º do mesmo artigo, aceitam o cumprimento exato da fração. Com isso, quem cumpriu exatamente a fração tem a comutação do Art. 13 negada. Provável erro da fórmula original, mantido por fidelidade à planilha: conferir contra o texto do Decreto.',
  ],
}
