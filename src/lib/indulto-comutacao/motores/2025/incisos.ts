...
export const AVISOS_2025 = {
  ...
  validarJuridicamente: [
    ...
    // A quinta ambiguidade (Art. 13 com `<` estrito, Cálculo!H138) foi RESOLVIDA pelo dono
    // do produto: o motor passou a aceitar o cumprimento exato da fração (`<=`), como manda
    // o texto do Decreto. Não há mais o que o advogado validar aqui, então o aviso saiu —
    // deixá-lo seria descrever um comportamento que o motor não tem mais.
  ],
}
